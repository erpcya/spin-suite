package org.erpya.app.businesspartner.initialsetup;
    ...
    protected void setupTabs() {
        ...
        ITab BusinessPartnerWizardStep = TabFactory.createTab(getApplicationContext())
                ...
                .withAdditionalField(FieldFactory.createField(getApplicationContext())
                        ...
                        .withName(getString(R.string.groupbusinesspartner))
                        .withReadOnly(false)
                        .withUpdateable(true)
                        .withMandatory(false)
                        .withDisplayType(DisplayType.STRING)
        ...
        @SuppressLint("ResourceType") ITab BusinessPartnerAddress = TabFactory.createTab(getApplicationContext())
